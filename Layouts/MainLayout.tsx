          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div>
              <div className='flex items-center gap-4 hover:underline'>
                <a href="/empresas" className='text-sm'>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
            <p>&copy; {new Date().getFullYear()}  <span className='text-black'><strong> <a href="https://www.bysmax.com" target='_blank'>Emmanuel H.</a></strong></span> e <span><strong><a href="mailto:ivanilich.rdz@tecmilenio.mx">Ivanilich R.</a></strong></span> Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
