    ...
    <div className="relative w-full max-w-md mx-auto">
      <Card className="overflow-hidden border-0 shadow-lg w-full">
        ...
        <div className="flex">
          ...
          {/* Ticket type */}
          <div className="w-[85%] bg-[#e91e63] py-3 flex justify-center items-center">
            <h2 className="text-white text-3xl font-bold">VIP</h2>
          </div>
        </div>
        ...
        <div className="bg-[#004d40] text-white p-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex items-center">
              <div className="mr-3">
                <svg className="w-8 h-8 text-[#e91e63]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
